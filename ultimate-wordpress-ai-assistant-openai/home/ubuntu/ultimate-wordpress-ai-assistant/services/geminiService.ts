...
- Afficher les métadonnées d'une catégorie [nom]. (Inclut la description, le slug, le le titre SEO, la méta-description et l'expression-clé principale de Yoast SEO).
