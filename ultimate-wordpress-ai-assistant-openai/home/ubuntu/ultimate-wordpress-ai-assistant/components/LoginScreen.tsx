...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, wpStatus, openAiStatus }) => {
  ...
  const isConnecting = wpStatus === 'connecting' || openAiStatus === 'connecting';
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-8 space-y-8 transform transition-all hover:scale-105 duration-300">
      ...
      <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <ConnectionStatusDisplay label="OpenAI API" status={openAiStatus} />
      </div>
    </div>
  );
};
